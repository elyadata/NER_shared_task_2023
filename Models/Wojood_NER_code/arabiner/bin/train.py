...
from arabiner.utils.helpers import (
    logging_config,
    load_object,
    make_output_dirs,
    set_seed,
...
def parse_args():
    ...
    parser.add_argument(
        "--overwrite", action="store_false", help="Overwrite output directory",
    )
...
def main(args):
    ...
    datasets, vocab = parse_conll_files(
    ...
    args.data_config["kwargs"]["bert_model"] = args.network_config["kwargs"][
        "bert_model"
    ]
